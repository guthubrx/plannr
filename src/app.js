            ...
            canvas.addEventListener('mousemove', function(e) {
                ...
                if (draggedMilestone && draggedMilestoneData) {
                    ...
                    if (isMilestone) {
                        ...
                        // Pour une tâche normale : déplacer en gardant la durée
                        const duration = task.duration || 7;
                        const newEndDate = new Date(finalDate + duration * 86400000);
                        ganttData[draggedTaskIndex].x[0] = finalDate;
                        ganttData[draggedTaskIndex].x[1] = newEndDate.getTime();
                    }
                }
